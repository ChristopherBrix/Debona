"""
This file contains abstractions for the network mappings. Note that both layers (FC,
Conv, ...) and activation functions (ReLU, Sigmoid, ...) are considered network
mappings.
...
class AbstractMapping:
    ...
    def is_linear(self) -> bool:
        raise NotImplementedError(
            f"is_linear(...) not implemented in {self.__class__.__name__}"
        )
    ...
    def get_subclasses(cls):
        ...
        import src.algorithm.mappings.layers  # pylint: disable=import-outside-toplevel,unused-import
        import src.algorithm.mappings.piecewise_linear  # pylint: disable=import-outside-toplevel
        import src.algorithm.mappings.s_shaped  # noqa: F401 pylint: disable=import-outside-toplevel
    ...
    def abstracted_torch_funcs(cls) -> list:
        ...
        raise NotImplementedError(
            f"abstracted_torch_funcs(...) not implemented in {cls.__name__}"
        )
    ...
    def _linear_relaxation_equal_bounds(
        ...
        Args:
            ...
            upper_bounds_concrete_in    : The concrete upper bounds of the input to the
                                          nodes
            relaxations                 : A Nx2 array with the a,b parameters of the
                                          relaxation lines for each node.
        """
